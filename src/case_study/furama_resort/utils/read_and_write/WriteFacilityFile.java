...
public class WriteFacilityFile {
    public void writeVillaFile(List<Villa> villaList) {
        ...
        StringBuilder data = new StringBuilder("Service Id,Service Name,Area,Cost,Max Person,Rental Type,Is Maintaining,Standard,Pool Area,Floors\n");
    ...
    public void writeHouseFile(List<House> houseList) {
        ...
        StringBuilder data = new StringBuilder("Service Id,Service Name,Area,Cost,Max Person,Rental Type,Is Maintaining,Standard,Floors\n");
    ...
    public void writeRoomFile(List<Room> roomList) {
        ...
        StringBuilder data = new StringBuilder("Service Id,Service Name,Area,Cost,Max Person,Rental Type,Is Maintaining,Free Service\n");
